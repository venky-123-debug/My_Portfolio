...
<div class="flex flex-col m-auto bg-aboutBg w-screen min-h-screen pb-60 overflow-hidden p-8">
  <div class="relative top-12 mx-auto h-32">
    <div class="relative text-center">
      <span class="text-8xl opacity-20 color font-bold relative z-10">SUMMARY</span>
  ...
  <div class="flex items-center justify-around pt-3 gap-6 w-full">
    <div class="w-1/2 flex items-center gap-6 flex-col">
      <div class="flex flex-col lg:flex-row gap-6 w-full">
        <!-- mondodb -->
        <div class="flex items-center justify-center h-16 bg-[#000000cc] w-full p-3 rounded-md">
    ...
    <div class="w-1/2 flex items-center gap-6 flex-col">
      ...
      <div class="flex flex-col lg:flex-row gap-6 w-full">
        ...
        <!-- <div class="flex items-center justify-center h-16 bg-[#000000cc] p-3 rounded-md">
          <div class="text-green-500 w-auto flex items-center justify-center h-full text-lg font-semibold">Bit Bucket</div>
          <div class="w-16 h-full pl-2 flex items-center justify-center">
            <i class="fa-brands text-3xl text-sky-500 fa-bitbucket"></i>
          </div>
        </div> -->
      </div>
    </div>
