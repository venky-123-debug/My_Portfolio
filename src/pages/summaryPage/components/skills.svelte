<div class="text-3xl font-bold pt-6 text-gray-200">Skills:</div>
...
<div class="grid-cols-1 items-center justify-around pt-3 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full">
  ...
  <a href="https://developer.mozilla.org/en-US/docs/Web/HTML" target="_blank" class="flex hover:scale-105 transition duration-150 card items-center justify-center h-16 w-full bg-[#000000cc] p-3 rounded-md">
    <div class="text-orange w-auto flex items-center justify-center h-full text-lg font-semibold">HTML</div>
    <div class="w-16 h-full pl-2 flex items-center justify-center">
      <i class="fa-brands text-3xl text-orange fa-html5"></i>
    </div>
  </a>
  <!-- tailwind-css -->
  <a href="https://tailwindcss.com" target="_blank" class="flex items-center justify-center hover:scale-105 transition duration-150 card h-16 w-full bg-[#000000cc] p-3 rounded-md">
  ...
  <!-- js -->
  <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" class="flex hover:scale-105 transition duration-150 card items-center justify-center h-16 w-full bg-[#000000cc] p-3 rounded-md">
    <div class="text-yellow-500 w-auto flex items-center justify-center h-full text-lg font-semibold">JavaScript</div>
    <div class="w-16 h-full pl-2 flex items-center justify-center">
      <i class="fa-brands text-3xl text-yellow-500 fa-js"></i>
    </div>
  </a>
  <!-- NodeJS -->
  <a href="https://nodejs.org/en" target="_blank" class="flex items-center justify-center h-16 hover:scale-105 transition duration-150 card w-full bg-[#000000cc] p-3 rounded-md">
  ...
  <!-- express js icon -->
  <a href="https://expressjs.com" target="_blank" class="flex items-center justify-center h-16 hover:scale-105 transition duration-150 card w-full bg-[#000000cc] p-3 rounded-md">
  ...
  <!-- svelte icon -->
  <a href="https://svelte.dev" target="_blank" class="flex items-center justify-center h-16 hover:scale-105 transition duration-150 card w-full bg-[#000000cc] p-3 rounded-md">
  ...
  <!-- GIT -->
  <a href="https://git-scm.com" target="_blank" class="flex items-center justify-center h-16 hover:scale-105 transition duration-150 card w-full bg-[#000000cc] p-3 rounded-md">
    <div class="text-green-500 w-auto flex items-center justify-center h-full text-lg font-semibold">GIT</div>
    <div class="w-16 h-full pl-2 flex items-center justify-center">
      <i class="fa-brands text-3xl text-rose-500 fa-git-alt"></i>
    </div>
  </a>
  <!-- NGINX -->
  <a href="https://nginx.org" target="_blank" class="flex items-center justify-center h-16 hover:scale-105 transition duration-150 card w-full bg-[#000000cc] p-3 rounded-md">
    <div class="text-[#009639] w-auto flex items-center justify-center h-full text-lg font-semibold">NGINX</div>
    <div class="w-16 h-full pl-2 flex items-center justify-center">
