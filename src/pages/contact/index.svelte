  ...
  <div class="relative isolate pb-24">
    <div class="relative top-12 mx-auto h-32">
      <div class="relative text-center">
        <span class="text-8xl opacity-10 text-gray-500 font-bold relative z-10">CONTACT</span>
        ...
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
            ...
            <div class="flex gap-x-4">
              ...
              <dd><a class="hover:text-white" href="tel:+1 (555) 234-5678">+917402161837</a></dd>
            </div>
            <div class="flex gap-x-4 pb-6 sm:pb-0">
              ...
              <dd><a class="hover:text-white" href="mailto:hello@example.com">venkatbe26494@gmail.com</a></dd>
            </div>
          </dl>
        </div>
      </div>
